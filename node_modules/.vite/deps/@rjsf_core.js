...
var ArrayField = class extends import_react.Component {
  ...
  constructor(props) {
    ...
    this.onCopyIndexClick = (index) => {
      return (event) => {
        ...
        const { keyedFormData: keyedFormData2 } = this.state;
        let newErrorSchema;
        if (errorSchema) {
          newErrorSchema = {};
          for (const idx in errorSchema) {
            ...
            if (i2 <= index) {
              (0, import_set.default)(newErrorSchema, [i2], errorSchema[idx]);
            } else if (i2 > index) {
              (0, import_set.default)(newErrorSchema, [i2 + 1], errorSchema[idx]);
            }
          }
        }
        const newKeyedFormDataRow = {
          key: generateRowId(),
          item: (0, import_cloneDeep.default)(keyedFormData2[index].item)
        };
        const newKeyedFormData = [...keyedFormData2];
        if (index !== void 0) {
    ...
    this.onDropIndexClick = (index) => {
      return (event) => {
        ...
        const newKeyedFormData = keyedFormData2.filter((_2, i2) => i2 !== index);
        this.setState({
          keyedFormData: newKeyedFormData,
          updatedKeyedFormData: true
        }, () => onChange(keyedToPlainFormData(newKeyedFormData), newErrorSchema));
        ...
        if (errorSchema) {
          ...
          for (const idx in errorSchema) {
            ...
            if (i2 == index) {
              ...
              (0, import_set.default)(newErrorSchema, [idx], errorSchema[i2]);
            }
          }
        }
        const { keyedFormData: keyedFormData2 } = this.state;
        function reOrderArray() {
          const _newKeyedFormData = keyedFormData2.slice();
          _newKeyedFormData.splice(index, 1);
          _newKeyedFormData.splice(newIndex, 0, keyedFormData2[index]);
    ...
    this.onChangeForIndex = (index) => {
      return (value, newErrorSchema, id) => {
        const { formData: formData2, onChange, errorSchema } = this.props;
        const arrayData = Array.isArray(formData2) ? formData2 : [];
  ...
  get itemTitle() {
    ...
    return (0, import_get.default)(schema, [ITEMS_KEY, "title"], (0, import_get.default)(schema, [ITEMS_KEY, "description"], translateString(TranslatableString.ArrayItemTitle)));
  }
...
var AnyOfField = class extends import_react2.Component {
  ...
  constructor(props) {
    ...
    this.onOptionChange = (option) => {
      const { selectedOption, retrievedOptions: retrievedOptions2 } = this.state;
      const { formData: formData2, onChange, registry } = this.props;
      const { schemaUtils: schemaUtils2 } = registry;
      const intOption = option !== void 0 ? parseInt(option, 10) : -1;
      if (intOption === selectedOption) {
        return;
      }
      const newOption = intOption >= 0 ? retrievedOptions2[intOption] : void 0;
      const oldOption = selectedOption >= 0 ? retrievedOptions2[selectedOption] : void 0;
      let newFormData = schemaUtils2.sanitizeDataForNewSchema(newOption, oldOption, formData2);
      if (newFormData && newOption) {
        newFormData = schemaUtils2.getDefaultFormState(newOption, newFormData, "excludeObjectChildren");
      }
  ...
  render() {
    ...
    const rawErrors = (0, import_get2.default)(errorSchema, ERRORS_KEY, []);
    const fieldErrorSchema = (0, import_omit.default)(errorSchema, [ERRORS_KEY]);
    const displayLabel = schemaUtils.getDisplayLabel(schema, uiSchema, globalUiOptions);
    ...
    return (0, import_jsx_runtime3.jsxs)("div", { className: "panel panel-default panel-body", children: [(0, import_jsx_runtime3.jsx)("div", { className: "form-group", children: (0, import_jsx_runtime3.jsx)(Widget, { id: this.getFieldId(), name: `${name}${schema.oneOf ? "__oneof_select" : "__anyof_select"}`, schema: { type: "number", default: 0 }, onChange: this.onOptionChange, onBlur, onFocus, disabled: disabled || (0, import_isEmpty.default)(enumOptions), multiple: false, rawErrors, errorSchema: fieldErrorSchema, value: selectedOption >= 0 ? selectedOption : void 0, options: { enumOptions, ...uiOptions }, registry, formContext, placeholder, autocomplete, autofocus, label: title !== null && title !== void 0 ? title : name, hideLabel: !displayLabel }) }), optionSchema && (0, import_jsx_runtime3.jsx)(_SchemaField, { ...this.props, schema: optionSchema, uiSchema: optionUiSchema })] });
  }
};
...
function NumberField(props) {
  ...
  let value = formData;
  const handleChange = (0, import_react3.useCallback)((value2) => {
    setLastValue(value2);
    if (`${value2}`.charAt(0) === ".") {
      value2 = `0${value2}`;
    }
  ...
  if (typeof lastValue === "string" && typeof value === "number") {
    const re2 = new RegExp(`${value}`.replace(".", "\\.") + "\\.?0*$");
  ...
  render() {
    ...
    const templateProps = {
      ...
      properties: orderedProperties.map((name2) => {
        const addedByAdditionalProperties = (0, import_has.default)(schema, [PROPERTIES_KEY, name2, ADDITIONAL_PROPERTY_FLAG]);
        ...
        return {
          content: (0, import_jsx_runtime5.jsx)(SchemaField2, { name: name2, required: this.isRequired(name2), schema: (0, import_get3.default)(schema, [PROPERTIES_KEY, name2], {}), uiSchema: fieldUiSchema, errorSchema: (0, import_get3.default)(errorSchema, name2), idSchema: fieldIdSchema, idPrefix, idSeparator, formData: (0, import_get3.default)(formData, name2), formContext, wasPropertyKeyModified: this.state.wasPropertyKeyModified, onKeyChange: this.onKeyChange(name2), onChange: this.onPropertyChange(name2, addedByAdditionalProperties), onBlur, onFocus, registry, disabled, readonly, hideError, onDropPropertyClick: this.onDropPropertyClick }, name2),
          name: name2,
          readonly,
          disabled,
          required,
...
function SchemaFieldRender(props) {
  ...
  if (UI_OPTIONS_KEY in fieldUiSchema) {
    fieldUiSchema[UI_OPTIONS_KEY] = (0, import_omit2.default)(fieldUiSchema[UI_OPTIONS_KEY], ["classNames", "style"]);
  }
  ...
  const richDescription = uiOptions.enableMarkdownInDescription ? (0, import_jsx_runtime6.jsx)(index_modern_default, { children: description }) : description;
  ...
  return (0, import_jsx_runtime6.jsx)(FieldTemplate2, { ...fieldProps, children: (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [field, schema.anyOf && !isReplacingAnyOrOneOf && !schemaUtils.isSelect(schema) && (0, import_jsx_runtime6.jsx)(_AnyOfField, { name, disabled, readonly, hideError, errorSchema, formData, formContext, idPrefix, idSchema, idSeparator, onBlur: props.onBlur, onChange: props.onChange, onFocus: props.onFocus, options: schema.anyOf.map((_schema2) => schemaUtils.retrieveSchema((0, import_isObject4.default)(_schema2) ? _schema2 : {}, formData)), registry, schema, uiSchema }), schema.oneOf && !isReplacingAnyOrOneOf && !schemaUtils.isSelect(schema) && (0, import_jsx_runtime6.jsx)(_OneOfField, { name, disabled, readonly, hideError, errorSchema, formData, formContext, idPrefix, idSchema, idSeparator, onBlur: props.onBlur, onChange: props.onChange, onFocus: props.onFocus, options: schema.oneOf.map((_schema2) => schemaUtils.retrieveSchema((0, import_isObject4.default)(_schema2) ? _schema2 : {}, formData)), registry, schema, uiSchema })] }) });
}
...
function BaseInputTemplate(props) {
  ...
  const _onFocus = (0, import_react7.useCallback)(({ target: { value: value2 } }) => onFocus(id, value2), [onFocus, id]);
...
function UnsupportedField(props) {
  ...
  return (0, import_jsx_runtime24.jsxs)("div", { className: "unsupported-field", children: [(0, import_jsx_runtime24.jsx)("p", { children: (0, import_jsx_runtime24.jsx)(index_modern_default, { children: translateString(translateEnum, translateParams) }) }), schema && (0, import_jsx_runtime24.jsx)("pre", { children: JSON.stringify(schema, null, 2) })] });
}
...
function WrapIfAdditionalTemplate(props) {
  ...
  return (0, import_jsx_runtime25.jsx)("div", { className: classNames, style, children: (0, import_jsx_runtime25.jsxs)("div", { className: "row", children: [(0, import_jsx_runtime25.jsx)("div", { className: "col-xs-5 form-additional", children: (0, import_jsx_runtime25.jsxs)("div", { className: "form-group", children: [(0, import_jsx_runtime25.jsx)(Label, { label: keyLabel, required, id: `${id}-key` }), (0, import_jsx_runtime25.jsx)("input", { className: "form-control", type: "text", id: `${id}-key`, onBlur: (event) => onKeyChange(event.target.value), defaultValue: label })] }) }), (0, import_jsx_runtime25.jsx)("div", { className: "form-additional form-group col-xs-5", children }), (0, import_jsx_runtime25.jsx)("div", { className: "col-xs-2", children: (0, import_jsx_runtime25.jsx)(RemoveButton2, { className: "array-item-remove btn-block", style: { border: "0" }, disabled: disabled || readonly, onClick: onDropPropertyClick(label), uiSchema, registry }) })] }) });
}
...
function DateElement({ type, range, value, select, rootId, name, disabled, readonly, autofocus, registry, onBlur, onFocus }) {
  ...
  return (0, import_jsx_runtime26.jsx)(SelectWidget2, { schema: { type: "integer" }, id, name, className: "form-control", options: { enumOptions: rangeOptions(range[0], range[1]) }, placeholder: type, value, disabled, readonly, autofocus, onChange: (value2) => select(type, value2), onBlur, onFocus, registry, label: "", "aria-describedby": ariaDescribedByIds(rootId) });
}
...
function CheckboxesWidget({ id, disabled, options: { inline = false, enumOptions, enumDisabled, emptyValue }, value, autofocus = false, readonly, onChange, onBlur, onFocus }) {
  ...
  const handleBlur = (0, import_react10.useCallback)(({ target: { value: value2 } }) => onBlur(id, enumOptionsValueForIndex(value2, enumOptions, emptyValue)), [onBlur, id]);
  const handleFocus = (0, import_react10.useCallback)(({ target: { value: value2 } }) => onFocus(id, enumOptionsValueForIndex(value2, enumOptions, emptyValue)), [onFocus, id]);
...
function RadioWidget({ options, value, required, disabled, readonly, autofocus = false, onBlur, onFocus, onChange, id }) {
  ...
  const handleBlur = (0, import_react13.useCallback)(({ target: { value: value2 } }) => onBlur(id, enumOptionsValueForIndex(value2, enumOptions, emptyValue)), [onBlur, id]);
  const handleFocus = (0, import_react13.useCallback)(({ target: { value: value2 } }) => onFocus(id, enumOptionsValueForIndex(value2, enumOptions, emptyValue)), [onFocus, id]);
...
function TextareaWidget({ id, options = {}, placeholder, value, required, disabled, readonly, autofocus = false, onChange, onBlur, onFocus }) {
  ...
  const handleBlur = (0, import_react15.useCallback)(({ target: { value: value2 } }) => onBlur(id, value2), [onBlur, id]);
  const handleFocus = (0, import_react15.useCallback)(({ target: { value: value2 } }) => onFocus(id, value2), [id, onFocus]);
...
function withTheme(themeProps) {
  return (0, import_react18.forwardRef)(({ fields: fields2, widgets: widgets2, templates: templates2, ...directProps }, ref) => {
    var _a;
    fields2 = { ...themeProps === null || themeProps === void 0 ? void 0 : themeProps.fields, ...fields2 };
    widgets2 = { ...themeProps === null || themeProps === void 0 ? void 0 : themeProps.widgets, ...widgets2 };
    templates2 = {
      ...
      ButtonTemplates: {
        ...
        ...templates2 === null || templates2 === void 0 ? void 0 : templates2.ButtonTemplates
      }
    };
