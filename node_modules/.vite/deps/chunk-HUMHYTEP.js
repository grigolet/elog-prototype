...
function mergeDefaultsWithFormData(defaults, formData, mergeExtraArrayDefaults = false) {
  ...
  if (isObject(formData)) {
    ...
    return Object.keys(formData).reduce((acc2, key) => {
      acc2[key] = mergeDefaultsWithFormData(defaults ? (0, import_get6.default)(defaults, key) : {}, (0, import_get6.default)(formData, key), mergeExtraArrayDefaults);
      return acc2;
    }, acc);
  }
  return formData;
...
function computeDefaults(validator, rawSchema, { parentDefaults, rawFormData, rootSchema = {}, includeUndefinedValues = false, _recurseList = [], experimental_defaultFormStateBehavior = void 0, required } = {}) {
  var _a, _b, _c, _d;
    ...
    case "object": {
      ...
      const objectDefaults = Object.keys(retrievedSchema.properties || {}).reduce((acc, key) => {
        ...
        const computedDefault = computeDefaults(validator, (0, import_get7.default)(retrievedSchema, [PROPERTIES_KEY, key]), {
          ...
          required: (_a2 = retrievedSchema.required) === null || _a2 === void 0 ? void 0 : _a2.includes(key)
        });
...
function toIdSchemaInternal(validator, schema, idPrefix, idSeparator, id, rootSchema, formData, _recurseList = []) {
  ...
  if (ITEMS_KEY in schema && !(0, import_get9.default)(schema, [ITEMS_KEY, REF_KEY])) {
    return toIdSchemaInternal(validator, (0, import_get9.default)(schema, ITEMS_KEY), idPrefix, idSeparator, id, rootSchema, formData, _recurseList);
  }
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HUMHYTEP.js.map
