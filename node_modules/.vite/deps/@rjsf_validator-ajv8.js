...
function transformRJSFValidationErrors(errors = [], uiSchema) {
  return errors.map((e) => {
    ...
    if ("missingProperty" in params) {
      ...
      const uiSchemaTitle = getUiOptions((0, import_get.default)(uiSchema, `${property.replace(/^\./, "")}`)).title;
      if (uiSchemaTitle) {
        message = message.replace(currentProperty, uiSchemaTitle);
      } else {
        const parentSchemaTitle = (0, import_get.default)(parentSchema, [PROPERTIES_KEY, currentProperty, "title"]);
...
var AJV8PrecompiledValidator = class {
   ...
   */
  getValidator(schema) {
    const key = (0, import_get2.default)(schema, ID_KEY) || hashForSchema(schema);
  ...
  isValid(schema, formData, rootSchema) {
    ...
    if ((0, import_get2.default)(schema, ID_KEY) === JUNK_OPTION_ID) {
      return false;
    }
